...
/**
*\*\file n32g401f8s7_1.h
*\*\author Nations
*\*\version v1.0.0
*\*\copyright Copyright (c) 2022, Nations Technologies Inc. All rights reserved.
**/ 
#ifndef __N32G401F8S7_1_H__
#define __N32G401F8S7_1_H__
...
/** In the following line adjust the External High Speed oscillator (HSE) Startup
   Timeout value **/
#define HSE_STARTUP_TIMEOUT ((uint16_t)0x1200) /* SYSCLK= 72M Time out for HSE start up */
#define HSI_STARTUP_TIMEOUT ((uint16_t)0x02D0) /* SYSCLK= 72M Time out for HSI start up */
#define LSI_STARTUP_TIMEOUT ((uint16_t)0x02D0) /* SYSCLK= 72M Time out for LSI start up */

#define HSI_VALUE (8000000) /* Value of the Internal oscillator in Hz */

#define __N32G401F8S7_1_STDPERIPH_VERSION_MAIN (0x00) /* [31:24] main version */
#define __N32G401F8S7_1_STDPERIPH_VERSION_SUB1 (0x04) /* [23:16] sub1 version */
#define __N32G401F8S7_1_STDPERIPH_VERSION_SUB2 (0x00) /* [15:8]  sub2 version */
#define __N32G401F8S7_1_STDPERIPH_VERSION_RC   (0x00) /* [7:0]  release candidate */

/** N32G401F8S7_1 Standard Peripheral Library version number **/
#define __N32G401F8S7_1_STDPERIPH_VERSION                                                                                    \
    ((__N32G401F8S7_1_STDPERIPH_VERSION_MAIN << 24) | (__N32G401F8S7_1_STDPERIPH_VERSION_SUB1 << 16)                               \
     | (__N32G401F8S7_1_STDPERIPH_VERSION_SUB2 << 8) | (__N32G401F8S7_1_STDPERIPH_VERSION_RC))

/** Configuration of the Cortex-M4 Processor and Core Peripherals **/
#ifdef N32G401F8S7_1
#define __MPU_PRESENT 1          /* N32G401F8S7_1 devices does not provide an MPU */
#define __FPU_PRESENT 1          /* FPU present */
#endif                           /* N32G401F8S7_1 */
#define __NVIC_PRIO_BITS       4 /* N32G401F8S7_1 uses 4 Bits for the Priority Levels    */
#define __Vendor_SysTickConfig 0 /* Set to 1 if different SysTick Config is used */


/*** N32G401F8S7_1 Interrupt Number Definition ***/
...
typedef enum IRQn
{
    ...
    /** N32G401F8S7_1 specific Interrupt Numbers  **/
    ...
    RESERVE21_IRQn       = 21, /* CReserved Interrupt                                 */
    ...
    UART1_IRQn           = 36, /* UART1 global Interrupt                              */
    USART2_IRQn          = 37, /* USART2 global Interrupt                              */
    RESERVE38_IRQn       = 38, /* Reserved Interrupt                               */
...
#include "core_cm4.h"
#include "system_n32g401f8s7_1.h"
#include <stdint.h>
#include <stdbool.h>
...
#define UART1      ((USART_Module*)UART1_BASE)
...
#define PWR_CTRL_CLRSTBF    ((uint16_t)0x0008) /* Clear Standby Flag */
...
#define PWR_CTRL_CLRWKUP    ((uint16_t)0x0800) /* Clear PA0 wakeup Flag */
...
#define PWR_CTRLSTS_WKUPF     ((uint16_t)0x0010) /* PA0 wakeup Flag */
#define PWR_CTRLSTS_WKUPRTCF  ((uint16_t)0x0040) /* RTC wakeup Flag */
#define PWR_CTRLSTS_WKUPEN    ((uint16_t)0x0200) /* Enable PA0_WKUP pin */
#define PWR_CTRLSTS_WKUPRTCEN ((uint16_t)0x0800) /* Enable RTC wakeup */
#define PWR_CTRLSTS_WKUPPS    ((uint16_t)0x2000) /* Wakeup polarity for PA0 */
...
#define RCC_APB2PRST_UART1RST ((uint32_t)0x00004000) /* USART 1 reset */
...
#define RCC_APB2PCLKEN_UART1EN ((uint32_t)0x00004000) /* USART 1 enable */
...
#define DMA_INTSTS_GLBF8 ((uint32_t)0x10000000) /* Channel 8 Global interrupt flag */
#define DMA_INTSTS_TXCF8 ((uint32_t)0x20000000) /* Channel 8 Transfer Complete flag */
#define DMA_INTSTS_HTXF8 ((uint32_t)0x40000000) /* Channel 8 Half Transfer flag */
#define DMA_INTSTS_ERRF8 ((uint32_t)0x80000000) /* Channel 8 Transfer Error flag */
...
#define DMA_INTCLR_CGLBF8 ((uint32_t)0x10000000) /* Channel 8 Global interrupt clear */
#define DMA_INTCLR_CTXCF8 ((uint32_t)0x20000000) /* Channel 8 Transfer Complete clear */
#define DMA_INTCLR_CHTXF8 ((uint32_t)0x40000000) /* Channel 8 Half Transfer clear */
#define DMA_INTCLR_CERRF8 ((uint32_t)0x80000000) /* Channel 8 Transfer Error clear */
...
#define DMA_CHCFG1_PRIOLVL   ((uint16_t)0x3000) /* PRIOLVL[1:0] bits(Channel Priority level) */
...
#define DMA_CHCFG2_PRIOLVL   ((uint16_t)0x3000) /* PRIOLVL[1:0] bits (Channel Priority level) */
...
#define DMA_CHCFG3_PRIOLVL   ((uint16_t)0x3000) /* PRIOLVL[1:0] bits (Channel Priority level) */
...
#define DMA_CHCFG4_PRIOLVL   ((uint16_t)0x3000) /* PRIOLVL[1:0] bits (Channel Priority level) */
...
#define DMA_CHCFG5_PRIOLVL   ((uint16_t)0x3000) /* PRIOLVL[1:0] bits (Channel Priority level) */
#define DMA_CHCFG5_PRIOLVL_0 ((uint16_t)0x1000) /* Bit 0 */
#define DMA_CHCFG5_PRIOLVL_1 ((uint16_t)0x2000) /* Bit 1 */

#define DMA_CHCFG5_MEM2MEM   ((uint16_t)0x4000) /* Memory to memory mode */
...
#define DMA_CHCFG6_PRIOLVL   ((uint16_t)0x3000) /* PRIOLVL[1:0] bits (Channel Priority level) */
...
#define DMA_CHCFG7_PRIOLVL   ((uint16_t)0x3000) /* PRIOLVL[1:0] bits (Channel Priority level) */
#define DMA_CHCFG7_PRIOLVL_0 ((uint16_t)0x1000) /* Bit 0 */
#define DMA_CHCFG7_PRIOLVL_1 ((uint16_t)0x2000) /* Bit 1 */

#define DMA_CHCFG7_MEM2MEM   ((uint16_t)0x4000) /* Memory to memory mode */
...
#define DMA_CHCFG8_PRIOLVL   ((uint16_t)0x3000) /* PRIOLVL[1:0] bits (Channel Priority level) */
#define DMA_CHCFG8_PRIOLVL_0 ((uint16_t)0x1000) /* Bit 0 */
#define DMA_CHCFG8_PRIOLVL_1 ((uint16_t)0x2000) /* Bit 1 */

#define DMA_CHCFG8_MEM2MEM   ((uint16_t)0x4000) /* Memory to memory mode */

/** Bit definition for DMA_TXNUM1 register **/
#define DMA_TXNUM1_NDTX ((uint16_t)0xFFFF) /* CH1 number of data to transfer */

/** Bit definition for DMA_TXNUM2 register **/
#define DMA_TXNUM2_NDTX ((uint16_t)0xFFFF) /* CH2 number of data to transfer */

/** Bit definition for DMA_TXNUM3 register **/
#define DMA_TXNUM3_NDTX ((uint16_t)0xFFFF) /* CH3 number of data to transfer */

/** Bit definition for DMA_TXNUM4 register **/
#define DMA_TXNUM4_NDTX ((uint16_t)0xFFFF) /* CH4 number of data to transfer */

/** Bit definition for DMA_TXNUM5 register **/
#define DMA_TXNUM5_NDTX ((uint16_t)0xFFFF) /* CH5 number of data to transfer */

/** Bit definition for DMA_TXNUM6 register **/
#define DMA_TXNUM6_NDTX ((uint16_t)0xFFFF) /* CH6 number of data to transfer */

/** Bit definition for DMA_TXNUM7 register **/
#define DMA_TXNUM7_NDTX ((uint16_t)0xFFFF) /* CH7 number of data to transfer */

/** Bit definition for DMA_TXNUM8 register **/
#define DMA_TXNUM8_NDTX ((uint16_t)0xFFFF) /* CH8 number of data to transfer */

/** Bit definition for DMA_PADDR1 register **/
#define DMA_PADDR1_ADDR ((uint32_t)0xFFFFFFFF) /* Peripheral Address of CH1 */

/** Bit definition for DMA_PADDR2 register **/
#define DMA_PADDR2_ADDR ((uint32_t)0xFFFFFFFF) /* Peripheral Address of CH2 */

/** Bit definition for DMA_PADDR3 register **/
#define DMA_PADDR3_ADDR ((uint32_t)0xFFFFFFFF) /* Peripheral Address of CH3 */

/** Bit definition for DMA_PADDR4 register **/
#define DMA_PADDR4_ADDR ((uint32_t)0xFFFFFFFF) /* Peripheral Address of CH4 */

/** Bit definition for DMA_PADDR5 register **/
#define DMA_PADDR5_ADDR ((uint32_t)0xFFFFFFFF) /* Peripheral Address of CH5 */

/** Bit definition for DMA_PADDR6 register **/
#define DMA_PADDR6_ADDR ((uint32_t)0xFFFFFFFF) /* Peripheral Address of CH6 */

/** Bit definition for DMA_PADDR7 register **/
#define DMA_PADDR7_ADDR ((uint32_t)0xFFFFFFFF) /* Peripheral Address of CH7 */

/** Bit definition for DMA_PADDR8 register **/
#define DMA_PADDR8_ADDR ((uint32_t)0xFFFFFFFF) /* Peripheral Address of CH8 */

/** Bit definition for DMA_MADDR1 register **/
#define DMA_MADDR1_ADDR ((uint32_t)0xFFFFFFFF) /* Memory Address of CH1 */

/** Bit definition for DMA_MADDR2 register **/
#define DMA_MADDR2_ADDR ((uint32_t)0xFFFFFFFF) /* Memory Address of CH2 */

/** Bit definition for DMA_MADDR3 register **/
#define DMA_MADDR3_ADDR ((uint32_t)0xFFFFFFFF) /* Memory Address of CH3 */

/** Bit definition for DMA_MADDR4 register **/
#define DMA_MADDR4_ADDR ((uint32_t)0xFFFFFFFF) /* Memory Address of CH4 */

/** Bit definition for DMA_MADDR5 register **/
#define DMA_MADDR5_ADDR ((uint32_t)0xFFFFFFFF) /* Memory Address of CH5 */

/** Bit definition for DMA_MADDR6 register **/
#define DMA_MADDR6_ADDR ((uint32_t)0xFFFFFFFF) /* Memory Address of CH6 */

/** Bit definition for DMA_MADDR7 register **/
#define DMA_MADDR7_ADDR ((uint32_t)0xFFFFFFFF) /* Memory Address of CH7 */

/** Bit definition for DMA_MADDR8 register **/
#define DMA_MADDR8_ADDR ((uint32_t)0xFFFFFFFF) /* Memory Address of CH8 */

/** Bit definition for DMA_CHSELx(x=1~8) register  ***/
#define DMA_CHSEL_CH_SEL   ((uint32_t)0x0000003F) /* CH_SEL[5:0]: Channel requst select */
#define DMA_CHSEL_CH_SEL_0 ((uint32_t)0x00000001) /* bit0 */
#define DMA_CHSEL_CH_SEL_1 ((uint32_t)0x00000002) /* bit1 */
#define DMA_CHSEL_CH_SEL_2 ((uint32_t)0x00000004) /* bit2 */
#define DMA_CHSEL_CH_SEL_3 ((uint32_t)0x00000008) /* bit3 */
#define DMA_CHSEL_CH_SEL_4 ((uint32_t)0x00000010) /* bit4 */
#define DMA_CHSEL_CH_SEL_5 ((uint32_t)0x00000020) /* bit5 */
...
#define TIM_CTRL1_IOMBKPEN  ((uint32_t)0x00000400) /* Break_in selection from IOM */
#define TIM_CTRL1_C1SEL     ((uint32_t)0x00000800) /* Channel 1 selection from IOM */
#define TIM_CTRL1_C2SEL     ((uint32_t)0x00001000) /* Channel 2 selection from IOM */
#define TIM_CTRL1_C3SEL     ((uint32_t)0x00002000) /* Channel 3 selection from IOM */
#define TIM_CTRL1_C4SEL     ((uint32_t)0x00004000) /* Channel 4 selection from IOM */
#define TIM_CTRL1_CLRSEL    ((uint32_t)0x00008000) /* OCxRef selection from ETR */
...
#define RTC_INITSTS_TAMF   ((uint32_t)0x00004000)
...
#define RTC_TMPCFG_TPMF       ((uint32_t)0x00200000)
#define RTC_TMPCFG_TPNOE      ((uint32_t)0x00100000)
...
#define RTC_TMPCFG_TPTRG      ((uint32_t)0x00000010)
#define RTC_TMPCFG_TPEN       ((uint32_t)0x00000008)
