...
void System_Initializes(void)
{
   ...
   /* Set HSIEN bit */
    ...
    RCC->CLKINT = (RCC_CLKINT_LSIRDICLR|RCC_CLKINT_HSIRDICLR
                  |RCC_CLKINT_HSERDICLR|RCC_CLKINT_PLLRDICLR
                  |RCC_CLKINT_CLKSSICLR);
...
*\*\
*\*\          HSI_VALUE is a constant defined in n32g401f8s7_1.h file (default value
*\*\             8 MHz) but the real value may vary depending on the variations
*\*\             in voltage and temperature.
*\*\
*\*\          HSE_VALUE is a constant defined in n32g401f8s7_1.h file (default value
