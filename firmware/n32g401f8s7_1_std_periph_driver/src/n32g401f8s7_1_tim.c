...
/**
*\*\file n32g401f8s7_1_tim.c
*\*\author Nations
*\*\version v1.0.0
*\*\copyright Copyright (c) 2022, Nations Technologies Inc. All rights reserved.
**/
#include "n32g401f8s7_1_tim.h"
...
*\*\          - TIM_IC_SELECTION_INDIRECTTI    TIM Input 3 is selected to be connected to IC4,not for TIM2.
...
*\*\          - TIM_IC_SELECTION_INDIRECTTI    TIM Input 4 is selected to be connected to IC3,not for TIM3.
...
**\           - TIM_CH_6
*\*\return  none
*\*\note    - TIM2 TIM3 TIM4 TIM5 does not support channel 5 and channel 6,TIM2 does not support channel 4,TIM2 does not support channel 3
**/
...
**\           - TIM_CH_3
*\*\return  none
*\*\note    - TIM_CH_2 is only for TIM1, only TIM1 has CH2N.
**/
...
*\*\          - RESET
*\*\note：
*\*\          - TIM_CC1NEN TIM_CC3NEN is used only with TIM1, TIM8.
*\*\          - TIM_CC2NEN is used only with TIM1.
**/
...
*\*\          - TIM_INT_CC4 is not for TIM2.
*\*\          - TIM_INT_CC3 is not for TIM3.
*\*\return  none
**/
...
*\*\          - TIM8
*\*\param   TIM_IT
*\*\          - TIM_FLAG_UPDATE TIM1 update Interrupt source
*\*\          - TIM_FLAG_CC1 TIM Capture Compare 1 Interrupt source
*\*\          - TIM_FLAG_CC2 TIM Capture Compare 2 Interrupt source
*\*\          - TIM_FLAG_CC3 TIM Capture Compare 3 Interrupt source
*\*\          - TIM_FLAG_CC4 TIM Capture Compare 4 Interrupt source
*\*\          - TIM_FLAG_COM TIM Commutation Interrupt source
*\*\          - TIM_FLAG_TRIG TIM Trigger Interrupt source
*\*\          - TIM_FLAG_BREAK TIM Break Interrupt source
*\*\note
*\*\          - TIM6 can have only one update flag.
*\*\          - TIM_FLAG_BREAK is used only with TIM1, TIM8.
*\*\          - TIM_FLAG_COM is used only with TIM1, TIM8.
*\*\          - TIM_FLAG_CC4 is not for TIM2.
*\*\          - TIM_FLAG_CC3 is not for TIM3.
*\*\return  none
**/
...
*\*\          - TIM_FLAG_CC4 is not for TIM2.
*\*\          - TIM_FLAG_CC3 is not for TIM3.
*\*\          - TIM_FLAG_CC4OF is not for TIM2.
*\*\          - TIM_FLAG_CC3OF is not for TIM3.
...
*\*\note
*\*\          - TIM_DMA_CC4 is not for TIM2.
*\*\          - TIM_DMA_CC3 is not for TIM3.
*\*\return  none
**/
