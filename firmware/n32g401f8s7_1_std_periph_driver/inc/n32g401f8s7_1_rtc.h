...
/**
*\*\file n32g401f8s7_1_rtc.h
*\*\author Nations
*\*\version v1.0.0
*\*\copyright Copyright (c) 2022, Nations Technologies Inc. All rights reserved.
**/

#ifndef __N32G401F8S7_1_RTC_H__
#define __N32G401F8S7_1_RTC_H__
...
#define RTC_FLAGS_MASK                           ((uint32_t)(RTC_FLAG_RECPF | RTC_FLAG_TAMF | RTC_FLAG_TISOVF | RTC_FLAG_TISF | RTC_FLAG_WTF | RTC_FLAG_ALBF | RTC_FLAG_ALAF | RTC_FLAG_INITF        \
...
#define RTC_FLAG_TAMF                            (RTC_INITSTS_TAMF)
...
#define RTC_INT_TAMP                             ((uint32_t)0x00040000)
...
#define RTC_TAMPER              RTC_TMPCFG_TPEN     /* Tamper detection enable for input tamper */

#define RTC_TAMPER_NOE          RTC_TMPCFG_TPNOE    /* Tamper event do not clear backup register */

#define RTC_TAMPER_INT          RTC_TMPCFG_TP2INTEN  /* Tamper detection interruput enable */
