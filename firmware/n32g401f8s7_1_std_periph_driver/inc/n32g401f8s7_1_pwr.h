...
/**
*\*\file n32g401f8s7_1_pwr.h
*\*\author Nations
*\*\version v1.0.0
*\*\copyright Copyright (c) 2022, Nations Technologies Inc. All rights reserved.
**/

#ifndef __N32G401F8S7_1_PWR_H__
#define __N32G401F8S7_1_PWR_H__
...
/** Alias word address of WKUPPS bit **/
#define PWR_CTRLSTS_OFFSET          (PWR_OFFSET + 0x04)
#define PWR_WKUPPS_BIT_NUM         (0x0D)
#define PWR_CTRLSTS_WKUPPS_BITBAND (PERIPH_BB_BASE + (PWR_CTRLSTS_OFFSET * 32) + (PWR_WKUPPS_BIT_NUM * 4))
...
#define PWR_WKUPEN_BIT_NUM         (0x09)
#define PWR_CTRLSTS_WKUPEN_BITBAND (PERIPH_BB_BASE + (PWR_CTRLSTS_OFFSET * 32) + (PWR_WKUPEN_BIT_NUM * 4))
...
/** PWR PA0/RTC wakeup Flag definition **/
#define PWR_WKUP_FLAG_PA0  ((uint32_t)PWR_CTRLSTS_WKUPF)
#define PWR_WKUP_FLAG_RTC  ((uint32_t)PWR_CTRLSTS_WKUPRTCF)

/** PWR Clear PA0/RTC wakeup Flag definition **/
#define PWR_CLEAR_WKUPF_ALL  ((uint32_t)(PWR_CTRL_CLRWKUP \
                                      | PWR_CTRL_CLRRTCWKUP))
#define PWR_CLEAR_WKUPF_PA0  ((uint32_t)PWR_CTRL_CLRWKUP)
#define PWR_CLEAR_WKUPF_RTC  ((uint32_t)PWR_CTRL_CLRRTCWKUP)

/** PWR wakup PIN definition **/
#define PWR_WKUPPA0_ENABLE  ((uint32_t)PWR_CTRLSTS_WKUPEN)
