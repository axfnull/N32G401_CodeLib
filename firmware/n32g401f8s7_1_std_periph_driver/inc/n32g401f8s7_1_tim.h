...
/**
*\*\file n32g401f8s7_1_tim.h
*\*\author Nations
*\*\version v1.0.0
*\*\copyright Copyright (c) 2022, Nations Technologies Inc. All rights reserved.
**/
#ifndef __N32G401F8S7_1_TIM_H__
#define __N32G401F8S7_1_TIM_H__
...
typedef struct
{
    ...
    bool CapCh2Sel;    /* channel 2 select capture in from IOM if 0
                                Tim2 valid*/
    bool CapCh3Sel;    /* channel 3 select capture in from LSI if 1, from IOM if 0
                                Tim2 valid*/
    bool CapCh4Sel;    /* channel 4 select capture in from IOM if 0 */
...
/*  modified for N32G401F8S7_1, add TIM_TRGO_SRC_OC4_7_8_9REF parameter*/
