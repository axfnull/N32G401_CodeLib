...
void GPIO_Configuration(void)
{
    ...
    GPIO_Peripheral_Initialize(GPIOA, &GPIO_InitStructure);
    /* Configure SPI_SLAVE pin: NSS */
    GPIO_InitStructure.Pin            = SPI_SLAVE_PIN_NSS;
    GPIO_InitStructure.GPIO_Alternate = GPIO_AF3_SPI2;
    GPIO_Peripheral_Initialize(GPIOA, &GPIO_InitStructure);
}
