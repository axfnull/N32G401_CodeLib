...
int main(void)
{
    ...
    ADC_Injected_Channels_Number_Config(ADC_INJECTED_LEN_2);
    /* ADC injected channel configuration */
    ADC_Injected_Sequence_Conversion_Number_Config(ADC_Channel_01_PA0, ADC_INJECTED_NUMBER_3);
    ADC_Channel_Sample_Time_Config(ADC_Channel_01_PA0 , ADC_SAMP_TIME_28CYCLES5);
    ADC_Injected_Sequence_Conversion_Number_Config(ADC_Channel_02_PA1, ADC_INJECTED_NUMBER_4);
...
void EXTI_Configuration(void)
{
    ...
    AFIO_ADC_External_Trigger_Remap_Set(AFIO_ADC_ETRI,AFIO_ADC_TRIG_EXTI_6);
    AFIO_ADC_External_Trigger_Remap_Set(AFIO_ADC_ETRR,AFIO_ADC_TRIG_EXTI_5);
    GPIO_EXTI_Line_Set(EXTI_LINE_SOURCE6, AFIO_EXTI_PA6);
    /* EXTI line6 configuration -----------------------------------------------*/
    ...
    /* Select the EXTI Line5 the GPIO pin source */
...
void GPIO_Configuration(void)
{
    ...
    GPIO_InitStructure.Pin       = GPIO_PIN_4 |GPIO_PIN_3 |GPIO_PIN_2 | GPIO_PIN_1;
