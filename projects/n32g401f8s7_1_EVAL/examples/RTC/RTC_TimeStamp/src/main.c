...
void EXTI_PA4_TimeStamp_Configuration(void);
...
int main(void)
{
    ...
    /* Configure EXTI PA4 pin  connected to RTC TimeStamp */
    EXTI_PA4_TimeStamp_Configuration();
    EXTI18_TimeStamp_IRQn_Configuration(ENABLE, 2);
    /* clear RTC time stamp flag  */
    RTC_Flag_Clear(RTC_FLAG_TISF);
    RTC_Flag_Clear(RTC_FLAG_TISOVF);
 
    RTC_TimeStamp_Enable(RTC_TIMESTAMP_EDGE_FALLING);
...
/**
*\*\name    EXTI_PA4_TimeStamp_Configuration
*\*\fun     EXTI PA4 I/O config and use the EXTI interrupt to trigger time stamp.
*\*\param   none
*\*\return  none
**/
void EXTI_PA4_TimeStamp_Configuration(void)
{
    ...
    /* Configure PA4 in alternate function mode */
    GPIO_InitStructure.Pin        = GPIO_PIN_4;
    GPIO_InitStructure.GPIO_Mode  = GPIO_MODE_INPUT;
    GPIO_InitStructure.GPIO_Pull  = GPIO_PULL_UP;
    GPIO_Peripheral_Initialize(GPIOA, &GPIO_InitStructure);

    /* Connect LINE4 to RTC Time Stamp */
    EXTI_RTC_Time_Stamp_Select(EXTI_TSSEL_LINE4);
