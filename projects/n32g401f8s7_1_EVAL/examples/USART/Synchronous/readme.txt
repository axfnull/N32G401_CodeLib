1. Function description
    ...
    USARTy and SPIy can be UART1 and SPI1, USART3 and SPI1, or USART2 and SPI2.
...
3. Instructions for use
    ...
    - USART2_Tx.PA2 <-------> SPI1_MOSI.PA7
    - USART2_Rx.PA3 <-------> SPI1_MISO.PA6
    - USART2_Clk.PA4 <-------> SPI1_SCK.PA5
