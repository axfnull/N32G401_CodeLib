...
void RCC_Configuration(void)
{
    ...
    RCC_AHB_Peripheral_Clock_Enable(RCC_AHB_PERIPH_GPIOA | RCC_AHB_PERIPH_GPIOB | RCC_AHB_PERIPH_DMA);
}
...
void GPIO_Configuration(void)
{
    ...
    GPIO_InitStructure.GPIO_Alternate = I2S_SLAVE_SD_ALTERNATE;
    GPIO_Peripheral_Initialize(I2S_SLAVE_SD_GPIO, &GPIO_InitStructure);

    GPIO_InitStructure.Pin            = I2S_SLAVE_WS_PIN;
    GPIO_InitStructure.GPIO_Mode      = GPIO_MODE_AF_PP;
    GPIO_InitStructure.GPIO_Slew_Rate = GPIO_SLEW_RATE_FAST;
    GPIO_InitStructure.GPIO_Alternate = I2S_SLAVE_WS_ALTERNATE;
    GPIO_Peripheral_Initialize(I2S_SLAVE_WS_GPIO, &GPIO_InitStructure);

    GPIO_InitStructure.Pin            = I2S_SLAVE_CK_PIN;
    GPIO_InitStructure.GPIO_Mode      = GPIO_MODE_AF_PP;
    GPIO_InitStructure.GPIO_Slew_Rate = GPIO_SLEW_RATE_FAST;
    GPIO_InitStructure.GPIO_Alternate = I2S_SLAVE_CK_ALTERNATE;
    GPIO_Peripheral_Initialize(I2S_SLAVE_CK_GPIO, &GPIO_InitStructure);

//    GPIO_InitStructure.Pin            = I2S_SLAVE_MCK_PIN;
//    GPIO_InitStructure.GPIO_Mode      = GPIO_MODE_AF_PP;
//    GPIO_InitStructure.GPIO_Slew_Rate = GPIO_SLEW_RATE_FAST;
//    GPIO_InitStructure.GPIO_Alternate = I2S_SLAVE_MCK_ALTERNATE;
//    GPIO_Peripheral_Initialize(I2S_SLAVE_MCK_GPIO, &GPIO_InitStructure);
    
    /* Configure master pins */
    GPIO_InitStructure.Pin            = I2S_MASTER_MCK_PIN;
    GPIO_InitStructure.GPIO_Mode      = GPIO_MODE_AF_PP;
    GPIO_InitStructure.GPIO_Slew_Rate = GPIO_SLEW_RATE_FAST;
    GPIO_InitStructure.GPIO_Alternate = I2S_MASTER_MCK_ALTERNATE;
    GPIO_Peripheral_Initialize(I2S_MASTER_MCK_GPIO, &GPIO_InitStructure);

    GPIO_InitStructure.Pin            = I2S_MASTER_SD_PIN;
    GPIO_InitStructure.GPIO_Mode      = GPIO_MODE_AF_PP;
    GPIO_InitStructure.GPIO_Slew_Rate = GPIO_SLEW_RATE_FAST;
    GPIO_InitStructure.GPIO_Alternate = I2S_MASTER_SD_ALTERNATE;
    GPIO_Peripheral_Initialize(I2S_MASTER_SD_GPIO, &GPIO_InitStructure);
    
    GPIO_InitStructure.Pin            = I2S_MASTER_WS_PIN;
    GPIO_InitStructure.GPIO_Mode      = GPIO_MODE_AF_PP;
    GPIO_InitStructure.GPIO_Slew_Rate = GPIO_SLEW_RATE_FAST;
    GPIO_InitStructure.GPIO_Alternate = I2S_MASTER_WS_ALTERNATE;
    GPIO_Peripheral_Initialize(I2S_MASTER_WS_GPIO, &GPIO_InitStructure);
    
    /* If CLKPOL is HIGH, set I2S_CK GPIO to GPIO_PULL_UP, otherwise set to GPIO_PULL_DOWN */
    GPIO_InitStructure.Pin            = I2S_MASTER_CK_PIN;
    GPIO_InitStructure.GPIO_Mode      = GPIO_MODE_AF_PP;
    GPIO_InitStructure.GPIO_Slew_Rate = GPIO_SLEW_RATE_FAST;
    GPIO_InitStructure.GPIO_Alternate = I2S_MASTER_CK_ALTERNATE;
    GPIO_InitStructure.GPIO_Pull      = GPIO_PULL_DOWN;
    GPIO_Peripheral_Initialize(I2S_MASTER_CK_GPIO, &GPIO_InitStructure);
}
