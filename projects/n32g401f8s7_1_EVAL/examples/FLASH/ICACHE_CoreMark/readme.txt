...
5. Note
	1. The coremask running time in the demo takes about 30s. You can change the running time by changing the value of the ITERATIONS macro. The running time should not be less than 10s.
    2. Because coremask needs a large STACK, make sure the Stack_Size is not less than 0x1000 before using this demo.